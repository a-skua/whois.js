...
${italic("publish")} = "技術書典14"

${gray("[[book]]")}
${italic("title")}   = "${green("実践入門WebAssembly")}"
${italic("publish")} = "インプレス NextPublishing"

${gray("[[book]]")}
${italic("title")}   = "${green("ご注文はWASIですか?")}"
${italic("publish")} = "技術書典15"

${gray("[[book]]")}
${italic("title")}   = "${green("ご注文はWASIですか??")}"
${italic("publish")} = "技術書典16"
